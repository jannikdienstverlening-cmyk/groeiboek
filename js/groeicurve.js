      ...
      datasets: [
        {
          ...
          data: lengtes,
          borderColor: '#B06280',
          backgroundColor: 'rgba(176,98,128,0.08)',
          tension: 0.3,
          yAxisID: 'y',
          spanGaps: true,
          pointRadius: 5,
        ...
        },
        {
          ...
          data: gewichten,
          borderColor: '#F0986A',
          backgroundColor: 'rgba(240,152,106,0.08)',
          tension: 0.3,
          yAxisID: 'y2',
          spanGaps: true,
          pointRadius: 5,
    ...
    options: {
      ...
      scales: {
        y: {
          type: 'linear',
          position: 'left',
          title: { display: true, text: 'Lengte (cm)', color: '#B06280' },
          ticks: { color: '#B06280' },
        ...
        y2: {
          type: 'linear',
          position: 'right',
          title: { display: true, text: 'Gewicht (kg)', color: '#F0986A' },
          ticks: { color: '#F0986A' },
